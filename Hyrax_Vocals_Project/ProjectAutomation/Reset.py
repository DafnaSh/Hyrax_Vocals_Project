...
# deleting units:
# TODO - find a way to change start_index index to 1
def reset_units(driver):
...
def reset_func(driver, case=None):
    reset_units(driver)  # 1. deleting all units in Koe units table
